...
with c2:
    img_base64 = load_image_base64(r"C:\Users\User\OneDrive\Documents\portfolio_app\pages\Data_Analyzer.jpeg")
    st.html(f"""
<style>
.fade-up-img {{
...
with c2:
    img_base64 = load_image_base64(r"C:\Users\User\OneDrive\Documents\portfolio_app\pages\RLC.jpg")
    st.html(f"""
<style>
.fade-in-slide {{
    animation: fadeInUp 1.5s ease-out forwards;
